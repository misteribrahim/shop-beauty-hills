...
const menu_data = [
  ...
  },
  {
    ...
    link: '/services',
    sub_menus: [
      { title: 'Manicures', link: '/services/Manicures' },
      { title: 'Procedures', link: '/services/procedures' },
      { title: 'Facial Treatments', link: '/services/facial-treatments' },
      { title: 'Body Treatments', link: '/services/body-treatments' },
      { title: 'Slimming Treatments', link: '/services/slimming-treatments' },
      { title: 'Massage', link: '/services/massage' },
      { title: 'Packages', link: '/services/packages' },
    ]
  },
  {
    id: 6,

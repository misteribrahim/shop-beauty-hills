                  ...
                  <div className="tp-footer-widget footer-col-4-1 mb-50">
                    ...
                    <div className="tp-footer-widget-content">
                      <div className="tp-footer-talk mb-20">
                        ...
                        <h4><a href="tel:670-413-90-762">+961 3 760 990</a></h4>
                      </div>
                      <div className="tp-footer-contact">
                        <div className="tp-footer-contact-item d-flex align-items-start">
                          ...
                          <div className="tp-footer-contact-content">
                            <p><a href="mailto:shofy@support.com">dermacarebeirut@gmail.com</a></p>
                          </div>
                        </div>
                        <div className="tp-footer-contact-item d-flex align-items-start">
                          <div className="tp-footer-contact-icon">
                          ...
                          <div className="tp-footer-contact-content">
                            <p><a href="https://maps.app.goo.gl/zX59BMLympdWZFM29?g_st=ic" target="_blank">79 Sleepy Hollow St. <br /> Lebanon</a></p>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="row align-items-center">
                  <div className="col-md-6">
                    <div className="tp-footer-copyright">
                      <p>© {new Date().getFullYear()} All Rights Reserved  | mr. Ibrahim
                        <Link href="/">web</Link>.
                      </p>
                    </div>
                  </div>
